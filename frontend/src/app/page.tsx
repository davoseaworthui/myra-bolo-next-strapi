...
export default async function Home() {
  ...
  return (
    <Container>
      <Hero />
      <Benefits />
      <ContentWithImage data={aboutMeData} />
...
const sectionHeading = {
  ...
  preHeading:
    'Every organisation needs strategic approach on career development',
  heading: 'I Can Assist You On Every Step',
  text: `For Your Company's`,
};
